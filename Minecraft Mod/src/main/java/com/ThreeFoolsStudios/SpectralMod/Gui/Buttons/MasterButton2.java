...
public class MasterButton2 extends GuiButton{
	
	private static final ResourceLocation Buttonpath = new ResourceLocation(Reference.MOD_ID+":textures/Gui/SpectralButtons/MasterSpell2.png");

	public MasterButton2(int buttonId, int x, int y, int widthIn, int heightIn,
			String buttonText) {
