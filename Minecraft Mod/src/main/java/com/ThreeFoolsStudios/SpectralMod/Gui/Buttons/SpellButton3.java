...
public class SpellButton3 extends GuiButton{

	private static final ResourceLocation Buttonpath1 = new ResourceLocation(Reference.MOD_ID+":textures/Gui/SpectralButtons/PoisonSpell2.png");
	private static final ResourceLocation Buttonpath2 = new ResourceLocation(Reference.MOD_ID+":textures/Gui/SpectralButtons/PoisonSpell3.png");
	
	private static final ResourceLocation Buttonpath3 = new ResourceLocation(Reference.MOD_ID+":textures/Gui/SpectralButtons/StormSpell2.png");
	private static final ResourceLocation Buttonpath4 = new ResourceLocation(Reference.MOD_ID+":textures/Gui/SpectralButtons/StormSpell3.png");
	
	private static final ResourceLocation Buttonpath5 = new ResourceLocation(Reference.MOD_ID+":textures/Gui/SpectralButtons/WarpSpell2.png");
	private static final ResourceLocation Buttonpath6 = new ResourceLocation(Reference.MOD_ID+":textures/Gui/SpectralButtons/WarpSpell3.png");
	
	public SpellButton3(int buttonId, int x, int y, int widthIn, int heightIn,
			String buttonText) {
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY)
    {
        ...
        if (this.visible)
        {
            ...
            if ((SpectralPlayer.GetNumberOfSpells() == 1 && SpectralPlayer.GetSpell3Level() == 1
				&& SpectralPlayer.GetSpectralLevel() == 2) || (SpectralPlayer.GetNumberOfSpells() == 2 
				&& SpectralPlayer.GetSpell1Level() == 1 && SpectralPlayer.GetSpell3Level() == 1 
				...
				&& SpectralPlayer.GetSpell3Level() == 1) || (SpectralPlayer.GetSpectralLevel() == 5 
				&& SpectralPlayer.GetSpell1Level() == 1 && SpectralPlayer.GetSpell2Level() == 2 
				&& SpectralPlayer.GetSpell3Level() == 1) || (SpectralPlayer.GetSpectralLevel() == 5 
				&& SpectralPlayer.GetSpell1Level() == 3 && SpectralPlayer.GetSpell3Level() == 1) ||
				(SpectralPlayer.GetSpectralLevel() == 5 && SpectralPlayer.GetSpell2Level() == 3
				...
				&& SpectralPlayer.GetSpell3Level() == 1) || (SpectralPlayer.GetSpectralLevel() == 7 
				...
				&& SpectralPlayer.GetSpell3Level() == 1) || (SpectralPlayer.GetSpectralLevel() == 8 
				&& SpectralPlayer.GetSpell1Level() == 3 && SpectralPlayer.GetSpell2Level() == 2 
				&& SpectralPlayer.GetSpell3Level() == 1 && SpectralPlayer.GetMasterSpell() != 0) ||
            	...
            	case 3:
					...
					(SpectralPlayer.GetSpectralLevel() == 5 && SpectralPlayer.GetSpell2Level() == 2
					&& SpectralPlayer.GetSpell3Level() == 2) || (SpectralPlayer.GetSpectralLevel() == 6 
					&& SpectralPlayer.GetSpell1Level() == 3 && SpectralPlayer.GetSpell3Level() == 2) ||
					(SpectralPlayer.GetSpectralLevel() == 6 && SpectralPlayer.GetSpell2Level() == 3
					&& SpectralPlayer.GetSpell3Level() == 2) || (SpectralPlayer.GetSpectralLevel() == 6 
					&& SpectralPlayer.GetSpell1Level() == 2 && SpectralPlayer.GetSpell2Level() == 1 
					&& SpectralPlayer.GetSpell3Level() == 2) || (SpectralPlayer.GetSpectralLevel() == 6 
					&& SpectralPlayer.GetSpell1Level() == 1 && SpectralPlayer.GetSpell2Level() == 2 
					...
					&& SpectralPlayer.GetSpell3Level() == 2) || (SpectralPlayer.GetSpectralLevel() == 7 
					&& SpectralPlayer.GetSpell1Level() == 3 && SpectralPlayer.GetSpell3Level() == 2 
					&& SpectralPlayer.GetMasterSpell() != 0) || (SpectralPlayer.GetSpectralLevel() == 7 
					...
					SpectralPlayer.GetMasterSpell() != 0) || (SpectralPlayer.GetSpectralLevel() == 9 
					&& SpectralPlayer.GetSpell1Level() == 3 && SpectralPlayer.GetSpell2Level() == 3 
					&& SpectralPlayer.GetSpell3Level() == 2) || (SpectralPlayer.GetSpectralLevel() == 9 
					&& SpectralPlayer.GetSpell1Level() == 3 && SpectralPlayer.GetSpell2Level() == 2 
					&& SpectralPlayer.GetSpell3Level() == 2 && SpectralPlayer.GetMasterSpell() != 0) ||
