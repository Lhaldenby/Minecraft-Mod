...
public class MasterButton extends GuiButton{
	
	private static final ResourceLocation Buttonpath = new ResourceLocation(Reference.MOD_ID+":textures/Gui/SpectralButtons/MasterSpell1.png");

	public MasterButton(int buttonId, int x, int y, int widthIn, int heightIn,
			String buttonText) {
