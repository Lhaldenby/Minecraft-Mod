...
public class SpellButtons extends GuiButton{

	private static final ResourceLocation Buttonpath1 = new ResourceLocation(Reference.MOD_ID+":textures/Gui/SpectralButtons/DigSpell2.png");
	private static final ResourceLocation Buttonpath2 = new ResourceLocation(Reference.MOD_ID+":textures/Gui/SpectralButtons/DigSpell3.png");

	private static final ResourceLocation Buttonpath3 = new ResourceLocation(Reference.MOD_ID+":textures/Gui/SpectralButtons/FireSpell2.png");
	private static final ResourceLocation Buttonpath4 = new ResourceLocation(Reference.MOD_ID+":textures/Gui/SpectralButtons/FireSpell3.png");

	private static final ResourceLocation Buttonpath5 = new ResourceLocation(Reference.MOD_ID+":textures/Gui/SpectralButtons/SummonSpell2.png");
	private static final ResourceLocation Buttonpath6 = new ResourceLocation(Reference.MOD_ID+":textures/Gui/SpectralButtons/SummonSpell3.png");

	
	public SpellButtons(int buttonId, int x, int y, int widthIn, int heightIn,
			String buttonText) {
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY)
    {
        ...
        if (this.visible)
        {
            ...
            if ((SpectralPlayer.GetNumberOfSpells() == 1 && SpectralPlayer.GetSpell1Level() == 1 
				...
				&& SpectralPlayer.GetSpell1Level() == 1) || (SpectralPlayer.GetSpectralLevel() == 5 
				...
				(SpectralPlayer.GetSpectralLevel() == 6 && SpectralPlayer.GetSpell3Level() == 3
				&& SpectralPlayer.GetSpell1Level() == 1 && SpectralPlayer.GetMasterSpell() != 0) ||
            	...
            	case 3:
					...
					(SpectralPlayer.GetSpectralLevel() == 4 && SpectralPlayer.GetSpell1Level() == 2 
					...
					(SpectralPlayer.GetSpectralLevel() == 6 && SpectralPlayer.GetSpell3Level() == 3
					&& SpectralPlayer.GetSpell1Level() == 2) || (SpectralPlayer.GetSpectralLevel() == 6 
					&& SpectralPlayer.GetSpell1Level() == 2 && SpectralPlayer.GetSpell2Level() == 2
